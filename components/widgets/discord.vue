    ...
    >
        ...
        >
            ...
            >
                ...
                <span
                    class="block pt-2 pb-1 text-sm text-gray-600 dark:text-gray-300"
                >
                    Techdiary কমিউনিটি ডিসকর্ড সার্ভারে যোগ দিন এবং অন্যান্য
                    সমমনা ডেভেলপারদের সাথে সংযোগ স্থাপন করুন!
                </span>
            </span>
        </a>
    </div>
