<template>
  <div class="grid grid-cols-12 gap-6 my-10 lg:gap-10">
    <aside class="col-span-3">
      <div>
        ...
        <div class="flex flex-col mt-2 space-y-2">
          <div class="flex items-center space-x-1" v-if="user.website_url">
            <svg
          ...
          <div class="flex items-center space-x-1" v-if="user.education">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-5 h-5"
              viewBox="0 0 20 20"
          ...
          <div class="flex items-center space-x-1" v-if="user.location">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-5 h-5"
              viewBox="0 0 20 20"
    ...
    <main class="col-span-9 border rounded">
      <!-- Navigation start -->
